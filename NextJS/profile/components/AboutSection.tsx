                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div className="profile-wrapper wow fadeInRight" data-wow-delay="0.3s">
                            ...
                            <Link href="#" className="btn btn-common"><i className="icon-paper-clip"></i> Download Resume</Link>
                            <Link href="#" className="btn btn-danger"><i className="icon-speech"></i> Contact Me</Link>
                        </div>
                    </div>
                </div>
            </div>
